...
S3bucket_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://stedi-lake-house-jchapto/customer/trusted"],
        "recurse": True,
    },
...
AmazonS3_node1690249397300 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://stedi-lake-house-jchapto/accelerometer/landing"],
        "recurse": True,
    },
...
S3bucket_node3 = glueContext.write_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "path": "s3://stedi-lake-house-jchapto/accelerometer/trusted/",
        "partitionKeys": [],
    },
